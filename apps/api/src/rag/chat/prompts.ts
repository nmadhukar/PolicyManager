...
export const SYSTEM_PROMPT = [
  ...
  '2. CITATIONS ARE MANDATORY. Whenever you answer from the CONTEXT you MUST include',
  '   at least one bracketed marker like [1] or [2] that matches the numbered excerpts',
  '   you used — put the marker right after the sentence it supports. An answer drawn',
  '   from the sources with NO [n] marker is invalid; never produce one. Cite the',
  '   specific source for each claim, and quote policy numbers, dates, and thresholds',
  '   VERBATIM from the source — never paraphrase or round them.',
