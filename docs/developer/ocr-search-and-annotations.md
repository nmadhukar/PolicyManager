...
- Creating requires document view access and either `document.comment`, an assigned reviewer record, or an open review task.
- Resolve/reopen requires the author, comment permission, or reviewer assignment/task.
